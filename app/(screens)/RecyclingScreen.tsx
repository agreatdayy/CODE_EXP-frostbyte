      ...
      <ParallaxScrollView
        ...
        <View style={styles.linkbox}>
          <View style={styles.linkBoxContainer}>
            <Text style={styles.quoteText}>'More reverse vending machines to encourage recycling of plastic drink bottles and aluminium cans'</Text>
            <Text style={styles.SecondLine}>-The Straits Times</Text>
            <View style={styles.contentContainer}>
              <Text style={styles.SecondLine}>Find your nearest vending machine </Text>
              <Text 
                style={styles.linkLine}
                onPress={() => Linking.openURL('https://recyclensave.sg/locations/')}>
                HERE!
              </Text>
            </View>
          </View> 
